...
namespace Microsoft.SystemCenter.Orchestrator.Integration.Administration
{
    public class IPUtilities
    {
        ...
        {
            return null;// GetScoCommonFilesDirectory(null);
        }
        ...
        */
        ...
        {
            return null; //GetScoManagementServerDirectory(null);
        }
        /*
        ...
        */
        ...
        {
            return null;// GetObjectsXmlFilePath(packID, null);
        }
        ...
        {
            return null; //GetOIPFilePath(packID, null);
        }
        /*
        ...
        {
            return null;// GetMSIFilePath(fileName, null);
        }
        /*
