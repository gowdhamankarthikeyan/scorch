...
{
    [ActivityData("Exchange Calendaring Mailbox Settings")]
    public class MailboxSettings
    {
        ...
        [ActivityInput("Exchange Version", Options = "Exchange2007_SP1,Exchange2010,Exchange2010_SP1")]
        ...
        [ActivityInput("Service URL",Default = "Autodiscover")]
