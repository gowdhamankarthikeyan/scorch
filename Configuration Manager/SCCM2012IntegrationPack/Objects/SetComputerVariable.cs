    ...
    public class SetComputerVariable : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            using(connection)
            {
                ...
                if (resourceID.Equals(String.Empty)) { col = CM2012Interop.getSCCMComputer(connection, "", machineName, ""); }
                else { col = CM2012Interop.getSCCMComputer(connection, resourceID, "", ""); }
