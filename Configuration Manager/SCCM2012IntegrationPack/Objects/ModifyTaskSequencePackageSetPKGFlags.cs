...
{
    [Activity("Modify SCCM Task Sequence Package: Set PKG Flags")]
    public class ModifyTaskSequencePackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CM2012Interop.modifySCCMTaskSequencePackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
