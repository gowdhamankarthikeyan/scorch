...
{
    [Activity("Modify SCCM Package: Set PKG Flags")]
    public class ModifyPackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CM2012Interop.modifySCCMPackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CM2012Interop.getSCCMPackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
