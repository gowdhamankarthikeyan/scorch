...
{
    [Activity("Modify SCCM Driver Package: Set PKG Flags")]
    public class ModifyDriverPackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CM2012Interop.modifySCCMDriverPackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CM2012Interop.getSCCMDriverPackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
