...
{
    [Activity("Modify SCCM Software Updates Package: Remove CIs")]
    public class ModifySoftwareUpdatesPackageRemoveCIs : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            designer.AddInput("Refresh DPs").WithBooleanBrowser().WithDefaultValue(true);
