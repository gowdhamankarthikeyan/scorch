...
{
    [Activity("Modify SCCM Driver Package")]
    public class ModifyDriverPackage : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            using(connection)
            {  
                String[] propertyNameChoices = CM2012Interop.getSCCMObjectPropertyNames(connection, "SMS_DriverPackage");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            try
            {
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CM2012Interop.modifySCCMDriverPackage(connection, objID, request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }

                IResultObject col = null;
                col = CM2012Interop.getSCCMDriverPackage(connection, "PackageID LIKE '" + objID + "'");
