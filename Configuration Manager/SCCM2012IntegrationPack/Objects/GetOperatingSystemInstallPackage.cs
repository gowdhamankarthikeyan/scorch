...
{
    [Activity("Get SCCM Operating System Install Package")]
    public class GetOperatingSystemInstallPackage : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                col = CM2012Interop.getSCCMOperatingSystemInstallPackage(connection, filter);
