...
{
    [Activity("Modify SCCM Operating System Install Package: Set PKG Flags")]
    public class ModifyOperatingSystemInstallPackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CM2012Interop.modifySCCMOperatingSystemInstallPackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CM2012Interop.getSCCMOperatingSystemInstallPackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
