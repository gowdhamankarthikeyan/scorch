...
{
    [Activity("Modify SCCM Operating System Install Package")]
    public class ModifyOperatingSystemInstallPackage : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            using(connection)
            {  
                String[] propertyNameChoices = CM2012Interop.getSCCMObjectPropertyNames(connection, "SMS_OperatingSystemInstallPackage");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            try
            {
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CM2012Interop.modifySCCMOperatingSystemInstallPackage(connection, objID, request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }

                IResultObject col = null;
                col = CM2012Interop.getSCCMOperatingSystemInstallPackage(connection, "PackageID LIKE '" + objID + "'");
