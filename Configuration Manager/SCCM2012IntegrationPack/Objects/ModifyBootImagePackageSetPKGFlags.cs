...
{
    [Activity("Modify SCCM Boot Image Package: Set PKG Flags")]
    public class ModifyBootImagePackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CM2012Interop.modifySCCMBootImagePackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CM2012Interop.getSCCMBootImagePackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
