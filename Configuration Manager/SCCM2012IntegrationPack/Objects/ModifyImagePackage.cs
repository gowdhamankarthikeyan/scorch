...
{
    [Activity("Modify SCCM Image Package")]
    public class ModifyImagePackage : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            using(connection)
            {  
                String[] propertyNameChoices = CM2012Interop.getSCCMObjectPropertyNames(connection, "SMS_ImagePackage");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CM2012Interop.modifySCCMImagePackage(connection, objID, request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }

                IResultObject col = null;
                col = CM2012Interop.getSCCMImagePackage(connection, "PackageID LIKE '" + objID + "'");
