...
{
    [ActivityData("Task Sequence Package Data")]
    public class taskSequencePackage
    {
        private int actionInProgress;
        private String alternateContentProviders;
        private String bootImagedID;
        private String category;
        private String customProgressMsg;
        ...
        private int taskSequenceFlags;
        private int type;
        private String version;

        internal taskSequencePackage(IResultObject obj)
        {
            obj.Get();
            ...
            this.bootImagedID = nullStringHandler(obj, "BootImageID");
            this.category = nullStringHandler(obj, "Category");
            this.customProgressMsg = nullStringHandler(obj, "CustomProgressMsg");
            ...
            this.sequence = nullStringHandler(obj, "Sequence");
            this.taskSequenceFlags = nullIntHandler(obj, "TaskSequenceFlags");
            this.type = nullIntHandler(obj, "type");
        ...
        [ActivityOutput, ActivityFilter]
        public String BootImagedID
        {
            get { return bootImagedID; }
        }
        [ActivityOutput, ActivityFilter]
        ...
        [ActivityOutput, ActivityFilter]
        public uint TaskSequenceFlags
        {
            get { return (uint)taskSequenceFlags; }
        }
        [ActivityOutput, ActivityFilter]
        public int Type
        {
