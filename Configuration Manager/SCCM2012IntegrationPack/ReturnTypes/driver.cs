...
{
    [ActivityData("Driver Information")]
    public class driver
    {
        ...
        private bool driverBootCritical;
        private String driverClass;
        private String driverDate;
        private String driverINFFile;
        private String driverProvider;
        private bool driverSigned;
        ...
        internal driver(IResultObject obj)
        {
            obj.Get();
            ...
            this.contentSourcePath = nullStringHandler(obj, "ContentSourcePath");
            ...
            this.driverBootCritical = nullBoolHandler(obj, "DriverBootCritical");
            this.driverClass = nullStringHandler(obj, "DriverClass");
            this.driverDate = nullDateTimeHandler(obj, "DriverDate");
            this.driverINFFile = nullStringHandler(obj, "DriverINFFile");
            this.driverProvider = nullStringHandler(obj, "DriverProvider");
            this.driverSigned = nullBoolHandler(obj, "DriverSigned");
            this.driverSigner = nullStringHandler(obj, "DriverSigner");
            this.driverType = nullStringHandler(obj, "DriverType");
            this.driverVersion = nullStringHandler(obj, "DriverVersion");
        ...
        [ActivityOutput, ActivityFilter]
        public bool DriverBootCritical
        {
            get { return driverBootCritical; }
        }
        [ActivityOutput, ActivityFilter]
        ...
        [ActivityOutput, ActivityFilter]
        public String DriverINFFile
        {
            get { return driverINFFile; }
        }
        [ActivityOutput, ActivityFilter]
        public String DriverProvider
        {
            get { return driverProvider; }
        }
        [ActivityOutput, ActivityFilter]
        public bool DriverSigned
        {
            get { return driverSigned; }
        }
        [ActivityOutput, ActivityFilter]
        public String DriverSigner
        {
            get { return driverSigner; }
        }
        [ActivityOutput, ActivityFilter]
