...
{
    [ActivityData("Boot Image Package Data")]
    public class bootImagePackage
    {
        ...
        internal bootImagePackage(IResultObject obj)
        {
            obj.Get();
            ...
            this.architecture = nullStringHandler(obj, "Architecture");
            this.backgroundBitmapPath = nullStringHandler(obj, "BackgroundBitmapPath");
            this.contextID = nullStringHandler(obj, "ContextID");
            this.description = obj["Description"].StringValue;
            this.enableLabShell = nullBoolHandler(obj, "EnableLabShell");
            ...
            this.imageIndex = nullIntHandler(obj, "ImageIndex");
            this.imagePath = nullStringHandler(obj, "ImagePath");
        ...
        {
            get { return backgroundBitmapPath; }
        }
        [ActivityOutput, ActivityFilter]
        ...
        [ActivityOutput, ActivityFilter]
        public bool EnableLabShell
        {
            get { return enableLabShell; }
        }
        [ActivityOutput, ActivityFilter]
        public String ImageDiskLayout
        {
            get { return imageDiskLayout; }
        }
        [ActivityOutput, ActivityFilter]
        ...
        private static bool nullBoolHandler(IResultObject obj, String propertyName)
        {
            bool retValue = false;

            try { retValue = obj[propertyName].BooleanValue; }
            catch { }
