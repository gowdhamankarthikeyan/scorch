...
{
    [Activity("Modify SCCM Software Updates Package: Set PKG Flags")]
    public class ModifySoftwareUpdatesPackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CMInterop.modifySCCMSoftwareUpdatesPackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
