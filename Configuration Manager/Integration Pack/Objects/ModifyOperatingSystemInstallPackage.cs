...
namespace SCCMExtension
{
    ...
    public class ModifyOperatingSystemInstallPackage : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            using(connection)
            {  
                String[] propertyNameChoices = CMInterop.getSCCMObjectPropertyNames(connection, "SMS_OperatingSystemInstallPackage");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            try
            {
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CMInterop.modifySCCMOperatingSystemInstallPackage(connection, objID, request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }

                IResultObject col = null;
                col = CMInterop.getSCCMOperatingSystemInstallPackage(connection, "PackageID LIKE '" + objID + "'");
