...
{
    [Activity("Get SCCM Software Updates Package")]
    public class GetSoftwareUpdatesPackage : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                col = CMInterop.getSCCMSoftwareUpdatesPackage(connection, filter);
