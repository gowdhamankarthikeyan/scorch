    ...
    public class ModifyBootImagePackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CMInterop.modifySCCMBootImagePackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CMInterop.getSCCMBootImagePackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
