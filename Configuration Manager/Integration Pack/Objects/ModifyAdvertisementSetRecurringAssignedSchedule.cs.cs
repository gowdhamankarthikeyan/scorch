...
namespace SCCMExtension
{
    ...
    public class ModifyAdvertisementSetRecurringAssignedSchedule : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            using(connection)
            {  
                CMInterop.modifySCCMAdvertisementAddAssignmentScheduleRecurring(connection, objID, isGMT, daySpan, hourSpan, minuteSpan, dayDuration, hourDuration, minuteDuration, startTime);
