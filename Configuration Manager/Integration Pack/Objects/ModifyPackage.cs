...
namespace SCCMExtension
{
    ...
    public class ModifyPackage : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            using(connection)
            {  
                String[] propertyNameChoices = CMInterop.getSCCMObjectPropertyNames(connection, "SMS_Package");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CMInterop.modifySCCMPackage(connection, objID, request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }
