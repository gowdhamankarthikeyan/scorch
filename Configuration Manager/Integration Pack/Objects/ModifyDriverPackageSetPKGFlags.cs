    ...
    public class ModifyDriverPackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CMInterop.modifySCCMDriverPackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CMInterop.getSCCMDriverPackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
