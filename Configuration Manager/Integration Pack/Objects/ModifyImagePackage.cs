        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CMInterop.modifySCCMImagePackage(connection, objID, request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }

                IResultObject col = null;
                col = CMInterop.getSCCMImagePackage(connection, "PackageID LIKE '" + objID + "'");
