    ...
    public class ModifyPackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CMInterop.modifySCCMPackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CMInterop.getSCCMPackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
