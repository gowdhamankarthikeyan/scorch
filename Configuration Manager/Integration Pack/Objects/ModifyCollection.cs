...
namespace SCCMExtension
{
    ...
    public class ModifyCollection : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            String[] propertyNameChoices = CMInterop.getSCCMObjectPropertyNames(connection, "SMS_Collection");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CMInterop.modifySCCMCollection(connection, objID, request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }
