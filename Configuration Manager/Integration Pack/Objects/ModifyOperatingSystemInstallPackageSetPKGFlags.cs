    ...
    public class ModifyOperatingSystemInstallPackageSetPKGFlags : IActivity
    {
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                CMInterop.modifySCCMOperatingSystemInstallPackage(connection, objID, "IntegerValue", "PkgFlags", flagsString);
                IResultObject col = CMInterop.getSCCMOperatingSystemInstallPackage(connection, "PackageID LIKE '" + objID + "'");
                if (col != null)
                {
