...
namespace SCCMExtension
{
    ...
    public class ModifyDriver : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            String[] propertyNameChoices = CMInterop.getSCCMObjectPropertyNames(connection, "SMS_Driver");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            {  
                ...
                foreach (String propertyName in propertyNameChoices)
                {
                    ...
                    {
                        CMInterop.modifySCCMDriver(connection, Convert.ToString(objID), request.Inputs[(propertyName + " : Property Type")].AsString(), propertyName, request.Inputs[(propertyName + " : Property Value")].AsString());
                    }
                }

                IResultObject col = null;
                col = CMInterop.getSCCMDriver(connection, "CI_ID LIKE '" + Convert.ToString(objID) + "'");
