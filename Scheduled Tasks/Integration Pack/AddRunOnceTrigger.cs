...
{
    [Activity("Add Run Once Task Trigger")]
    class AddRunOnceTrigger : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            designer.AddInput("Datetime to Run Task");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            dateTime = request.Inputs["Datetime to Run Task"].AsString();
