...
{
    [Activity("Restart Virtual Machine")]
    class RestartVM : IActivity
    {
        ...
        private String NoRecursion = String.Empty;
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            designer.AddInput("Guest Restart").WithListBrowser(guestOption);
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            GuestCommand = request.Inputs["Guest Restart"].AsString();
        ...
        private IEnumerable<vm> startVM()
        {
            ...
            if (GuestCommand.Equals("true")) { command = "Restart-VMGuest"; }
