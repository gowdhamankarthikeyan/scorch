...
namespace VMWareIntegrationPack
{
    ...
    class SetSnapshot : IActivity
    {
        ...
        {
            designer.AddInput("Snapshot Name");
            designer.AddInput("New Name").NotRequired();
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            Snapshot = request.Inputs["Snapshot Name"].AsString();
            Name = request.Inputs["New Name"].AsString();
