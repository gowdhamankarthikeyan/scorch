...
{
    [Activity("Remove Virtual Machine")]
    class RemoveVM : IActivity
    {
        ...
        private String DeleteFromDisk = String.Empty;
        ...
        {
            string[] DeleteFromDiskOptions = new string[2];
            DeleteFromDiskOptions[0] = "true";
            DeleteFromDiskOptions[1] = "false";

            designer.AddInput("VM");
            designer.AddInput("DeleteFromDisk").WithListBrowser(DeleteFromDiskOptions).WithDefaultValue("false");
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            DeleteFromDisk = request.Inputs["DeleteFromDisk"].AsString();
        ...
        private IEnumerable<vm> runCommand()
        {
            ...
            if (DeleteFromDisk.Equals("true")) { command += " -DeleteFromDisk"; }
