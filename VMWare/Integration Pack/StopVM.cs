...
{
    [Activity("Stop Virtual Machine")]
    class StopVM : IActivity
    {
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            designer.AddInput("Guest Shutdown").WithListBrowser(guestOption);
        ...
        public void Execute(IActivityRequest request, IActivityResponse response)
        {
            ...
            GuestCommand = request.Inputs["Guest Shutdown"].AsString();
        ...
        private IEnumerable<vm> startVM()
        {
            ...
            if (GuestCommand.Equals("true")) { command = "Shutdown-VMGuest"; }
