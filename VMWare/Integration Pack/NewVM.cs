...
{
    [Activity("New Virtual Machine")]
    class NewVM : IActivity
    {
        ...
        private String VApp = String.Empty;
        private String Folder = String.Empty;
        private String Datastore = String.Empty;
        private String DiskMB = String.Empty;
        private String DiskPath = String.Empty;
        private String DiskStorageFormat = String.Empty;
        ...
        private String VMFilePath = String.Empty;
        private String VMHost = String.Empty;

        private String floppy = String.Empty;
        ...
        public void Design(IActivityDesigner designer)
        {
            ...
            string[] floppyOptions = new string[2];
            floppyOptions[0] = "true";
            floppyOptions[1] = "false";

            string[] CDDriveOptions = new string[2];
            CDDriveOptions[0] = "true";
            CDDriveOptions[1] = "false";

            designer.AddInput("Name").NotRequired();
            designer.AddInput("VMHost").NotRequired();
            designer.AddInput("VMFilePath").NotRequired();
            designer.AddInput("ResourcePool").NotRequired();
            designer.AddInput("VApp").NotRequired();
            designer.AddInput("Folder").NotRequired();
            designer.AddInput("Datastore").NotRequired();
            designer.AddInput("DiskMB").NotRequired().WithDefaultValue("4096");
            designer.AddInput("DiskPath").NotRequired();
            designer.AddInput("DiskStorageFormat").NotRequired();
            designer.AddInput("MemoryMB").NotRequired().WithDefaultValue("256");
            designer.AddInput("NumCpu").NotRequired().WithDefaultValue("1").WithListBrowser(NumCPUOptions);
            ...
            designer.AddInput("VM To Clone").NotRequired();
            designer.AddInput("Template").NotRequired();

            designer.AddInput("CD").NotRequired().WithListBrowser(CDDriveOptions);
            designer.AddInput("Floppy").NotRequired().WithListBrowser(floppyOptions);
        ...
        private IEnumerable<vm> getVM()
        {
            ...
            if (!(VMFilePath == String.Empty)) { command += " -VMFilePath \"" + VMFilePath + "\""; }
            if (!(Folder == String.Empty)) { command += " -Location \"" + Folder + "\""; }
            ...
            if (!(DiskMB == String.Empty)) { command += " -DiskMB \"" + DiskMB + "\""; }
            if (!(DiskPath == String.Empty)) { command += " -DiskPath \"" + DiskPath + "\""; }
            if (!(DiskStorageFormat == String.Empty)) { command += " -DiskStorageFormat \"" + DiskStorageFormat + "\""; }
            ...
            if (floppy.Equals("true")) { command += " -floppy"; }
            if (CD.Equals("true")) { command += " -CD"; }
